    ...
    <PublicLayout>
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              How <span className="text-black">Champs</span><span className="text-primary"> SMART</span> Works
            </h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
        ...
        <div className="container mx-auto px-6 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-10">
              Join thousands of happy families already using <span className="text-black font-medium">Champs</span><span className="text-primary font-medium"> SMART</span>.
            </p>
